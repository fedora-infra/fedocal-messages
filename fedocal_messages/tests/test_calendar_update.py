...
from ..messages import CalendarUpdateV1
...
def test_minimal():
    ...
    message = CalendarUpdateV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = CalendarUpdateV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has updated a calendar test_calendar"
    message = CalendarUpdateV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy_user has updated a calendar test_calendar"
    message = CalendarUpdateV1(body=body)
