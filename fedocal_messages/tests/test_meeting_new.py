...
from ..messages import MeetingNewV1
...
def test_minimal():
    ...
    message = MeetingNewV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = MeetingNewV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has created a new meeting wat in calendar test_calendar"
    message = MeetingNewV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = (
        "dummy_user has created a new meeting wat in calendar test_calendar"
    )
    message = MeetingNewV1(body=body)
