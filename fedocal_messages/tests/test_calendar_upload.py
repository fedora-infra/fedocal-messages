...
from ..messages import CalendarUploadV1
...
def test_minimal():
    ...
    message = CalendarUploadV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = CalendarUploadV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has uploaded meetings in the calendar test_calendar"
    message = CalendarUploadV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy_user has uploaded meetings in the calendar test_calendar"
    message = CalendarUploadV1(body=body)
