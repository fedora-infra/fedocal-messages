...
from ..messages import MeetingUpdateV1
...
def test_minimal():
    ...
    message = MeetingUpdateV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = MeetingUpdateV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has updated meeting wat in calendar test_calendar"
    message = MeetingUpdateV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy_user has updated meeting wat in calendar test_calendar"
    message = MeetingUpdateV1(body=body)
