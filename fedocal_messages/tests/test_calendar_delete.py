...
def test_minimal():
    ...
    message = CalendarDeleteV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = CalendarDeleteV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has deleted the calendar test_calendar"
    message = CalendarDeleteV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy_user has deleted the calendar test_calendar"
    message = CalendarDeleteV1(body=body)
