...
from ..messages import CalendarClearV1
...
def test_minimal():
    ...
    message = CalendarClearV1(body=body)
    message.validate()
...
def test_missing_fields():
    ...
    message = CalendarClearV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = "dummy_user has cleared the calendar test_calendar"
    message = CalendarClearV1(body=body)
    message.validate()
...
def test_summary():
    ...
    expected_summary = "dummy_user has cleared the calendar test_calendar"
    message = CalendarClearV1(body=body)
