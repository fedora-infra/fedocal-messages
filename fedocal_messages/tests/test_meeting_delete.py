...
from ..messages import MeetingDeleteV1
...
def test_missing_fields():
    ...
    message = MeetingDeleteV1(body=minimal_message)
...
def test_str():
    ...
    expected_str = (
        "dummy_user has deleted the meeting wat from the calendar test_calendar"
    )
    message = MeetingDeleteV1(body=body)
    message.validate()
